...
import { text, medLength1, medLength2, medLength3, medFont } from '../utils/stylesRules';
  ...
  return(<>
    ...
    <CentrarPrincipalContenedor>
      <PrincipalContenedor
        ...
        <ImagenesContenedor>
          <Logo
            href='https://cashpak.com'
            enlaceImagen='data:image/png;base64,'
            nombre='Cash Pak'/>
          <Logo
            href='https://airpak.com/cashpak/'
            enlaceImagen='https://airpak.com/cashpak/wp-content/uploads/2021/03/envialana-300x154.png'
            nombre='Envia Lana'/>
          <Logo
            href='https://airpak.com'
            enlaceImagen='https://grupocoen.com/wp-content/uploads/2020/08/airpak-min.png'
            nombre='Air Pak'/>
          <Logo
            href='https://www.westernunion.com/'
            enlaceImagen='https://1000marcas.net/wp-content/uploads/2020/07/Western-Union-Logo-2013.jpg'
            nombre='Western Union'/>
          <Logo
            href='https://moneygram.mx/'
            enlaceImagen='https://photos.prnewswire.com/prnfull/20150730/251082LOGO?max=200'
            nombre='Money Gram'/>
        </ImagenesContenedor>
      </PrincipalContenedor>
    </CentrarPrincipalContenedor>
